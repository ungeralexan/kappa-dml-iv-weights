...
In tuned specifications, hyperparameter selection is likewise restricted to
the corresponding outer training sample, so that observations in the
evaluation fold are used neither for nuisance estimation nor for tuning.

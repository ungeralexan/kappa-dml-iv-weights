...
produces different results, Appendix Table~\ref{tab:vietnam_dml_appendix}
...
five-fold cross-fitting \citep{bach2022doubleml}. The identity column records
whether the recovered outcome weights reproduce the fitted point estimate to
the numerical tolerance used in the analysis. Because the XGBoost weights do
not pass this check, their near-zero sum is not interpreted as an exact
